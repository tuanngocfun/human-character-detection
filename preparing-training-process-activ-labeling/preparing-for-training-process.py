...
source_dir = "/media/ngoc/a normal usb/ngoc/training-set/active-lbl-train-with-add-data"
image_dest_dir = "/media/ngoc/a normal usb/ngoc/training-set/active-lbl-2200-upscale-low-pixel/images"
label_dest_dir = "/media/ngoc/a normal usb/ngoc/training-set/active-lbl-2200-upscale-low-pixel/labels"
...
if os.path.exists(classes_txt_path):
    shutil.copy(classes_txt_path, "/media/ngoc/a normal usb/ngoc/training-set/active-lbl-2200-upscale-low-pixel/")
