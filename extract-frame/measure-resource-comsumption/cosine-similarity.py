...
class FrameExtractor:
    ...
    def extract_frames_from_directory(self):
        ...
        print(f"RAM usage increase: {end_ram - start_ram} MB")

# Usage example:
src_folder = '../../../dataset/preprocessing-train-set/anime/filter-vid9'
dst_folder = '../../../dataset/preprocessing-train-set/measure-resources/cosine-similarity/extract-anime/filter-anime-frame9'
frame_diff_threshold = 0.1  # Adjust as needed
cos_sim_threshold = 0.1  # Cosine similarity threshold; adjust as needed
interval_ms = 200  # Time interval in milliseconds
