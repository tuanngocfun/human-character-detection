...
# Kernel Density Estimate for the dataset and Normal Distribution curve
...
plt.plot(x, pdf, color='blue', label='Standard Normal Distribution Curve')

# Shading the region within 1 standard deviation of the mean
plt.fill_between(x, pdf, where=((x > mean_score - std_dev) & (x < mean_score + std_dev)), color='grey', alpha=0.5, label=f'{percentage_within_one_sd:.2f}% of Data under KDE')
...
# Labels and title
plt.title('Kernel Density Estimate, Normal Distribution, and Data within 1 SD')
