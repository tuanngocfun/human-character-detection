...
source_dir = "/media/ngoc/a normal usb/ngoc/test-set2/refine/activ-labeling"
image_dest_dir = "/media/ngoc/a normal usb/ngoc/test-set2/refine/test2/images"
label_dest_dir = "/media/ngoc/a normal usb/ngoc/test-set2/refine/test2/labels"
    ...
    if filename.endswith('.txt') and filename != 'classes.txt':
        with open(filepath, 'r') as file:
            ...
            if content:
                ...
                shutil.move(filepath, label_dest_path)
        ...
        if os.path.exists(text_filepath):
            with open(text_filepath, 'r') as text_file:
                ...
                if text_content:
                    ...
                    shutil.move(filepath, image_dest_path)

# Move 'classes.txt' file if exists
classes_txt_path = os.path.join(source_dir, 'classes.txt')
if os.path.exists(classes_txt_path):
    shutil.move(classes_txt_path, "/media/ngoc/a normal usb/ngoc/test-set2/refine/test2/")
