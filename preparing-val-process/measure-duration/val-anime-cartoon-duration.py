...
anime_dir1 = '/media/ngoc/a normal usb/ngoc-data-thesis/videos/val'
anime_dir2 = '/media/ngoc/a normal usb/ngoc-data-thesis/videos/val/vid'
cartoon_dir = '/media/ngoc/a normal usb/ngoc-data-thesis/videos/val/unclassified'
...
anime_mp4_files = list(find_mp4_files(anime_dir1)) + list(find_mp4_files(anime_dir2))
