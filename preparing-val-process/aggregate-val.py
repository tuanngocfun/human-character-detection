...
def copy_subdirectories(subdir_name, destination_path):
    ...
    source_dirs = ["val", "val1", "val2", "val3", "val4"]
...
valid_first_phase_path = "/media/ngoc/a normal usb/ngoc/new-val/valid-refirst-phase"

# Copy images subdirectory
copy_subdirectories("images", os.path.join(valid_first_phase_path, "images"))

# Copy labels subdirectory
copy_subdirectories("labels", os.path.join(valid_first_phase_path, "labels"))
