...
image_src_dir = "/media/ngoc/a normal usb/ngoc/new-val/valid-second-phase-with-val5-style-transfer-repair1/images"
label_src_dir = "/media/ngoc/a normal usb/ngoc/new-val/valid-second-phase-with-val5-style-transfer-repair1/labels"

# Destination directory for the copied files
dest_dir = "/media/ngoc/a normal usb/ngoc/new-val/activ-learning-with-25-img-val"
