...
def copy_jpg_files(src_folder, target_folder):
    ...
    pattern1 = re.compile(r'merge-filter-anime-frame-for-train\d+')
    pattern2 = re.compile(r'merge-filter-anime-frame-for-train\d+-similarity-groups')
...
src_dir = '/media/ngoc/mydisk/ngoc/thesis/dataset/preprocessing-train-set/extract-anime'
target_dir = '/media/ngoc/mydisk/ngoc/thesis/dataset/preprocessing-train-set/extract-anime/cp-all-merge-anime'
