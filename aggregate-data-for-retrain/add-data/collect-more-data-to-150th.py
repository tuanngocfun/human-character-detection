...
data_paths = {
    'data1':('/media/ngoc/a normal usb/ngoc/training-set/150th/images',
      '/media/ngoc/a normal usb/ngoc/training-set/150th/labels'),
...
target_images_dir = '/media/ngoc/a normal usb/ngoc/training-set/aggregate4-upscale-low-quality-with-manually-lbl-adding-data-to-150th/images'
target_labels_dir = '/media/ngoc/a normal usb/ngoc/training-set/aggregate4-upscale-low-quality-with-manually-lbl-adding-data-to-150th/labels'
