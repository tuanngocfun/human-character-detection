...
data_paths = {
    'data1': ('/media/ngoc/mydisk/ngoc/thesis/data-qualty-assessment/image-quality-assessment/test/refine/anime',
              '/media/ngoc/a normal usb/ngoc/thesis/ultralytics/runs/detect/predict13/labels'),
    'data2': ('/media/ngoc/mydisk/ngoc/thesis/data-qualty-assessment/image-quality-assessment/test/refine/cartoon',
              '/media/ngoc/a normal usb/ngoc/thesis/ultralytics/runs/detect/predict14/labels'),
    'data3': ('/media/ngoc/mydisk/ngoc/thesis/data-qualty-assessment/image-quality-assessment/test/refine/merge-anime-cartoon-similarity-groups',
              '/media/ngoc/a normal usb/ngoc/thesis/ultralytics/runs/detect/predict27/labels'),
}

target_images_dir = '/media/ngoc/a normal usb/ngoc/training-set/aggregate4-upscale-low-quality/images'
target_labels_dir = '/media/ngoc/a normal usb/ngoc/training-set/aggregate4-upscale-low-quality/labels'
