...
root_directory = '/media/ngoc/mydisk/ngoc/thesis/dataset/preprocessing-train-set/extract-anime'
target_directory = os.path.join(root_directory, 're-combine-anime')
...
patterns = [f'filter-anime-frame{i}' for i in range(1, 16)]
